...
module.exports = (config, options, targetOptions) => {
  return {
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@angular/core': { singleton: true, strictVersion: true, requiredVersion: '13.1.1' },
          '@angular/common': { singleton: true, strictVersion: true, requiredVersion: '13.1.1' },
          '@angular/common/http': { singleton: true, strictVersion: true, requiredVersion: '13.1.1' },
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: '13.1.1' },
          '@angular/forms': { singleton: true, strictVersion: true, requiredVersion: '13.1.1' },
          '@angular/platform-browser': { singleton: true, strictVersion: true, requiredVersion: '13.1.1' },
          ...
          rxjs: { singleton: true, strictVersion: true, requiredVersion: '7.5.1' },
          'rxjs/operators': { singleton: true, strictVersion: true, requiredVersion: '7.5.1' },
    ...
    output: {
      publicPath: 'auto',
      uniqueName: 'organizationappointmentservice',
